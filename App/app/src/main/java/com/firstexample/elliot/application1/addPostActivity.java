        ...
        (findViewById(R.id.addButton)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Objects.equals("default",uName)){
                    ...
                    if (subjectName.getText().length() < 1){
                        errorString += "Subject name is too short. ";
                    }

                    if(content.getText().length() < 1){
                        errorString += "Content is too short. ";
                    }
                    ...
                    if(errorString != ""){
                        ...
                        post p = new post(uName, content.getText().toString(), date, subjectName.getText().toString(), helper.numberOfPosts());
