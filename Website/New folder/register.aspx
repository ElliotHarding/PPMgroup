...
<asp:Content ID="registerContent" ContentPlaceHolderID="bodyContent" Runat="Server">
    ...
    <div class="signIn">
        ...
        <asp:TextBox ID="passwordTXT" runat="server" CssClass="entry" Height="16px" Width="226px" BackColor="DarkGray"></asp:TextBox>          
        <br />
        <br />
    ...
    <div class="register">
        ...
        <asp:Button ID="registerButton" runat="server" OnClick="registerButton_Click" Text="Register" Width="120px" />
    </div>
    </div>
</asp:Content>